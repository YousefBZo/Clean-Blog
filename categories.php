            ...
            <ul>
                ...
                if (count($categories) > 0) {
                    foreach ($categories as $category) {
                        ?>
                        <li>
                            <a class="btn-mod btn-11" href="category.php?id=<?= $category['id'] ?>"><img
                                    src="https://img.icons8.com/carbon-copy/100/000000/trust.png" /></a>
                            <a href="category.php?id=<?= $category['id'] ?>">Furniture</a>
                        </li>
                    <?PHP }
                } else {
