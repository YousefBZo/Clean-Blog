                                ...
                                <div class="card-body">
                                    ...
                                    try {
                                        ...
                                        if (isset($_POST['editPost'])) {
                                            ...
                                            $featrued_image = trim($_POST['featrued_image']);
                                    ...
                                    <form accept-charset="utf-8" method="post" action="">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2" for="">Category id</label>
                                            <div class="col-sm-10">
                                                <select name="category_id" class="form-control">
                                                    <?php
                                                    $categories = new Admin;
                                                    foreach ($categories->getAllBlogCategories() as $categroy) {
                                                        ?>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2" for="featrued_image">Feature image</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="featrued_image" placeholder="Feature image"
                                                    class="form-control">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="editor1" class="form-control" cols="40" rows="10"
                                                    name="excerpt">
                                                    </textarea>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2" for="content">Content </label>
                                            <div class="col-sm-10">
                                                <textarea id="editor" class="form-control" cols="40" rows="10"
